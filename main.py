...
trees = []
temp1 = []; temp2 = []; temp3 = []; temp4 = [] # temporary trees tracking variables
uProfit = 0; lProfit = 0; rProfit = 0; dProfit = 0 # profit variables

# calculate_profit function
def cal_profit(tree):
    currentProfit = 0

    # calculating upprofit and assigning it to currentProfit
    upProfit(tree)
    currentProfit = uProfit
    direction = 0

    # calculating downprofit and comparing with currentProfit
    downProfit(tree)
    if dProfit > currentProfit:
        currentProfit = dProfit
        direction = 1

    # calculating rightprofit and comparing with currentProfit
    rightProfit(tree)
    if rProfit > currentProfit:
        currentProfit = rProfit
        direction = 2

    # calculating leftprofit and comparing with currentProfit
    leftProfit(tree)
    if lProfit > currentProfit:
        currentProfit = lProfit
        direction = 3

    return direction,currentProfit  # returning direction, currentProfit
...
# path1 function
"""sorting based on ratio of total profit (including profit by domino effect)
#to the time required to travel and cut a given tree from the current position, and the next
#priority for sorting is given to the value of the tree."""
...
# path2 function
""" ratio of value to the time required to travel and cut a given tree from the current position,
and the last priority for sorting is given to the value of the tree."""
...
for i in trees:
    ...
    uProfit = 0; lProfit = 0; rProfit = 0; dProfit = 0

trees = path1()[0] # calling path1 function and getting trees from path1
...
# ------------------- cutting trees --------------------
    ...
    # comparing profits from path1 and path2
