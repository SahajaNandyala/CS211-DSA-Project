...
def path():
    ...
    # list.sort(key = lambda x: (-(x["value"]/(abs(x["x"]-current_x)+abs(x["y"]-current_y)+x["d"])),(x["x"]-current_x)**2 + (x["y"]-current_y)**2,-(x["value"]))) --> 65
    # list.sort(key = lambda x: (-(x["value"]//(abs(x["x"]-current_x)+abs(x["y"]-current_y)+x["d"])),-(x["value"]),(x["x"]-current_x)**2 + (x["y"]-current_y)**2))
    # list.sort(key = lambda x: -(x["value"]/(abs(x["x"]-current_x)+abs(x["y"]-current_y)+x["d"]))) --> 64.9 Score
    # list.sort(key = lambda x: -(x["value"]+(abs(x["x"]-current_x)+abs(x["y"]-current_y)+x["d"]))) --> 35.30 Score --> neve ever use it
    # list.sort(key = lambda x: -((x["value"]+(abs(x["x"]-current_x)+abs(x["y"]-current_y)+x["d"]))/(abs(x["x"]-current_x)+abs(x["y"]-current_y)))) --> 60.08
    # list.sort(key = lambda x: ((abs(x["x"]-current_x)+abs(x["y"]-current_y)+x["d"]),(abs(x["x"]-current_x)+abs(x["y"]-current_y)+x["d"])/x["value"])) --> 44.52
    # list.sort(key = lambda x: (abs(x["x"]-current_x)+abs(x["y"]-current_y),(abs(x["x"]-current_x)+abs(x["y"]-current_y)+x["d"])/x["value"])) --> 47.89

    list.sort(key = lambda x: (-((x["value"]+x["tree_profit"])/(abs(x["x"]-current_x)+abs(x["y"]-current_y)+x["d"])),(x["x"]-current_x)**2 + (x["y"]-current_y)**2,-(x["value"])))
...
trees.sort(key = lambda x: x["x"]+ x["y"])
