...
def upProfit(near_tree):
    global uProfit
    uptrees = [i for i in trees if near_tree["x"] == i["x"] and near_tree["y"] < i["y"]]
    uptrees.sort(key=lambda j: j["y"])
    for i in uptrees:
...
while time <= time_limit and len(trees)>0:
    ...
    list1,path1_p = path1()
    direction1 = path1_p[0]
    path1_profit = path1_p[1]

    if direction1 == 0: path1_temp = temp1
    elif direction1 == 1: path1_temp = temp2
    elif direction1 == 2: path1_temp = temp3
    elif direction1 == 3: path1_temp = temp4
    ...
    list2,path2_p = path2()
    direction2 = path2_p[0]
    path2_profit = path2_p[1]

    if direction2 == 0: path2_temp = temp1
    elif direction2 == 1: path2_temp = temp2
    elif direction2 == 2: path2_temp = temp3
    elif direction2 == 3: path2_temp = temp4
